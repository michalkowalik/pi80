//
// Created by Michal Kowalik on 04.01.24.
// Basic interpreter + bootloader
//
...
static const uint16_t stage2_basic_start_address = 0x0000;	  // Phase 2 payload A image starting address
static const uint16_t stage2_basic_size = 0x1db3;			  // Phase 2 payload A image size
static const uint8_t stage2_basic[]  = {			          // Phase 2 payload A image (S121216 uBIOS + Basic)
